    ...
    <div className={classes.root}>
      ...
      >
        ...
        <Grid container
            ...
            <TextField id="outlined-search" fullWidth  label="Direccion" type="search" variant="outlined" />
            </Grid>
        ...
        <Grid container
            ...
            <Grid item >
            <TextField  id="outlined-search" label="Empresa" type="search" variant="outlined" />
            <TextField id="outlined-search" label="Area" type="search" variant="outlined" />
            </Grid>
