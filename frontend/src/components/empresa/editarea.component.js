            ...
            >
                <Fade in={open}>
                    <div className={classes.paper}>
                        ...
                        <TextField id="name2" label="Nombre del area" color="secondary" onChange={onChangeName} defaultValue={props.areaname} />

                        <Button variant="contained" color="primary" onClick={updateArea}>
                            Guardar
                        </Button>
                    </div>
                </Fade>
